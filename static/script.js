...
var _loadPdf = function( file ){
  ...
  if( file.mime === 'application/pdf' ){
    $('iframe').attr( 'src', 'https://' + location.hostname + '/app/6/pdfjs/web/viewer.html?file=https://download.inevio.com/' + file.id );
  }else if( file.formats && file.formats.pdf ){
    $('iframe').attr( 'src', 'https://' + location.hostname + '/app/6/pdfjs/web/viewer.html?file=https://download.inevio.com/' + file.id + '/format/pdf' );
  }else{
